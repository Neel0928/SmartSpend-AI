  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-64 bg-[#0a0a0a]/95 lg:bg-[#0a0a0a]/80 backdrop-blur-xl border-r border-white/10 
        h-full flex flex-col text-gray-300
        ...
        <div className="p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400">AI-Powered Finance</p>
            </div>
          </div>
          {onClose && (
            <button onClick={onClose} className="lg:hidden text-gray-400 hover:text-white p-1 rounded hover:bg-white/5">
              <X className="w-5 h-5" />
            </button>
          )}
        </div>
