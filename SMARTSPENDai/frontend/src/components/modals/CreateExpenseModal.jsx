...
import { X, Calendar, DollarSign, Tag, CreditCard, Landmark, FileText, CheckCircle } from 'lucide-react';
...
export default function CreateExpenseModal({ isOpen, onClose, onExpenseCreated }) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-4 py-2.5 w-full rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium text-lg"
                  placeholder="0.00"
                />
              </div>
            </div>
            ...
            {/* Merchant / Name */}
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1.5">Merchant / Title</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
