...
export default function AIInsightCard({ refreshTrigger }) {
  ...
  return (
    <div className="bg-[#F8F9FE] rounded-xl p-6 h-full relative overflow-hidden flex flex-col group min-h-[160px]">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-start">
        {loading ? (
          <div className="space-y-3 animate-pulse">
            <p className="text-gray-500 text-sm italic">Analyzing your spending...</p>
      ...
      <div className="absolute top-0 right-0 w-32 h-32 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 pointer-events-none"></div>
    </div>
  );
}
